...
--- ★ DML ★ ---
----------------
-- 1. INSERT TNTO 테이블명 (필드명1, 필드명2, ....) VALUES (값1, 값2,..);
   -- INSERT TNTO 테이블명 VALUES (값1, 값2, ..값N);
SELECT * FROM DEPT01;
INSERT INTO DEPT01 VALUES (50, 'ACCOUNTING', 'SEOUL');
INSERT INTO DEPT01 (DEPTNO, LOC, DNAME) VALUES (60, '심림', '개발');
INSERT INTO DEPT01 (DEPTNO, LOC, DNAME) VALUES (70, NULL, '영업');--명시적 NULL입력
INSERT INTO DEPT01 (DEPTNO, DNAME) VALUES (80, '연구');-- 묵시적 NULL 입력
SELECT * FROM DEPT01;
-- 서브쿼리를 이용한 INSERT
    --ex. DETP테이블의 20~40분서의 내용을 DEPT01테이블에 INSERT
